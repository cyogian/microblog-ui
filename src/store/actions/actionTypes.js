...
// CreateUser actions
export const CREATE_USER_START = "UPDATE_EMAIL_START";
export const CREATE_USER_SUCCESS = "UPDATE_EMAIL_SUCCESS";
export const CREATE_USER_FAIL = "UPDATE_EMAIL_FAIL";
export const CREATE_USER_RESET = "UPDATE_EMAIL_RESET";
export const CREATE_USER_VERIFY_START = "UPDATE_EMAIL_VERIFY_START";
export const CREATE_USER_VERIFY_SUCCESS = "UPDATE_EMAIL_VERIFY_SUCCESS";
export const CREATE_USER_VERIFY_FAIL = "UPDATE_EMAIL_VERIFY_FAIL";
export const CREATE_USER_VERIFY_RESET = "UPDATE_EMAIL_VERIFY_RESET";
export const CREATE_USER_RESEND_START = "UPDATE_EMAIL_RESEND_START";
export const CREATE_USER_RESEND_SUCCESS = "UPDATE_EMAIL_RESEND_SUCCESS";
export const CREATE_USER_RESEND_FAIL = "UPDATE_EMAIL_RESEND_FAIL";
export const CREATE_USER_RESEND_RESET = "UPDATE_EMAIL_RESEND_RESET";
